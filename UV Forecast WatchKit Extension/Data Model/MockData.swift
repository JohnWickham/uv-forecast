...
let days: [Day] = [
	Day(startDate: Date(), sunriseDate: Date(timeIntervalSince1970: 1586257320), sunsetDate: Date(timeIntervalSince1970: 1586303400), daytimeForecasts: timelineEntries, allForecasts: timelineEntries, highForecast: timelineEntries.max() as! UVForecast)
]
